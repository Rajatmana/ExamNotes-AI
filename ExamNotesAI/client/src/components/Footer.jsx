...
rounded-2xl
bg-linear-to-br from-black/90 via-black/80
to-black/90 backdrop-blur-2xl
        ...
        <div className="text-center">
         ...
         <div className="text-center">
            ...
            <ul className="space-y-2 text-sm">
                ...
                <li className="text-gray-300 hover:text-white transition-colors">rajatmana91@gmail.com</li>
            </ul>
        </div>
      </div>

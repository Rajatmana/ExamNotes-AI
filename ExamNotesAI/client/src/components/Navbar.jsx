...
function Navbar() {
    ...
    const[showCredits, setShowCredts] = useState(false)
  ...
  return (
    ...
    backdrop-blur-2xl border boreder-white/10 
    ...
    flex items-center justify-between px-8 py-4'>
        ...
        <div className='flex items-center gap-6 relative'>
            <div className='relative'>
                <motion.div
                onClick={()=>{setShowCredts(!showCredits);setshowProfile(false)}}
                whileHover={{scale:1.07}}
                whileTap={{scale:0.97}}
                className='flex items-center gap-1 
                px-2 py-2 rounded-full bg-white/10 border
                border-white/20 text-white text-sm shadow-md
                cursor-pointer'>
                ...
                whileTap={{scale:0.97}}
                className='ml-2 h-5 w-5 flex items-center rounded-full
                justify-center bg-white text-xs font-bold'>    
                ➕
                    </motion.span>
                </motion.div>
                <AnimatePresence>
                ...
                shadow-[0_25px_60px_rgba(0,0,0,0.7)] p-4 text-white'>
                    ...
                    <button
                    onClick={()=>{setShowCredts(false);navigate("/pricing")}}
                    className='w-full py-2 rounded-lg
                    bg-linear-to-br from-white to-gray-200
                    text-black font-semibold hover:opacity-90'>Buy More Credits</button>
            ...
            <div className='relative'>
                <motion.div
                onClick={()=>{setshowProfile(!showProfile);setShowCredts(false)}}

  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-black px-8">
      ...
      <main className="max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        >
          <h1
            className="text-5xl lg:text-6xl font-extrabold leading-tight bg-linear-to-br from-black/60 to-black/90
          ...
          onClick={handleGoogleAuth}
            ...
            className="mt-10 px-10 py-3 rounded-xl flex items-center gap-3 bg-linear-to-br from-black/90 via-black/80 to-black/90
                border border-white/10 text-white font-semibold text-lg shadow-[0_25px_60px_rgba(0,0,0,0.7)]"
          >
            <FcGoogle size={22} />
            Continue with Google
          </motion.button>
          <p className="mt-6 max-w-xl text-lg bg-linear-to-br from-gray-700 via-gray-500/80
          to-gray-700 bg-clip-text text-transparent">
            You get <span className="font-semibold">200 FREE credits</span> to create exam notes, project notes, 
            charts, graphs and download clean PDFs - instantly using AI.
          </p>
          <p className="mt-4 text-sm text-gray-500">Start with 200 free credits * Upgrade anytime for more credits * Instant access</p>
        </motion.div>

        {/* RIGHT */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <Feature icon="🎁" title="200 Free Credits" des="Start with 200 credits to generate notes without paying." />
...
function Feature({icon, title, des}){
    return(
        ...
        whileHover={{
            ...
            transition={{ type: "spring", stiffness: 200, damping: 18 }}
         className="relative rounded-2xl p-6 bg-linear-to-br from-black/90 via-black/80
        to-black/90 backdrop-blur-2xl border border-white/10 shadow-[0_30px_80px_rgba(0,0,0,0.7)]
        text-white" style={{transformStyle: "preserve-3d"}}
        >

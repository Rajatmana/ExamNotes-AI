  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-100 to-gray-200 px-6 py-8">
      <motion.header
        ...
        border-white/10 px-8 py-6 shadow-[0_20px_45px_rgba(0,0,0,0.6)] items-start flex md:items-center justify-between gap-4 flex-col md:flex-row"
      >
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <button onClick={()=>navigate("/history")} className="px-4 py-3 rounded-full text-sm font-medium bg-white/10 border border-white/20 text-white transition flex items-center gap-2">
          📚 Your Notes
          </button>
        </div>
      </motion.header>
